...
const AuthenticatedAppStack = () => {
    ...
    return (
        <>
            <Stack.Navigator
                screenOptions={{ headerShown: false, navigationBarColor: colors.background.light }}
                initialRouteName="MainTabNavigator">
                <Stack.Screen name="MainTabNavigator" component={MainTabNavigator} />
                <Stack.Screen name="CreateLobbyScreen" component={CreateLobbyScreen} />
                <Stack.Screen name="CharacterNameScreen" component={CharacterNameScreen} />
                <Stack.Screen name="CharacterGenderScreen" component={CharacterGenderScreen} />
                <Stack.Screen name="CharacterAgeScreen" component={CharacterAgeScreen} />
                <Stack.Screen name="CharacterLanguageScreen" component={CharacterLanguageScreen} />
                <Stack.Screen name="CharacterTagScreen" component={CharacterTagScreen} />
                <Stack.Screen name="CharacterImageScreen" component={CharacterImageScreen} />
                <Stack.Screen name="CharacterDetailScreen" component={CharacterDetailScreen} />
                <Stack.Screen name="CharacterFinalScreen" component={CharacterFinalScreen} />
                <Stack.Screen name="CreatingCharacterScreen" component={CreatingCharacterScreen} />
                <Stack.Screen name="CharacterSuccessScreen" component={CharacterSuccessScreen} />
                <Stack.Screen
