...
const slice = createSlice({
    ...
    reducers: {
        ...
        setLoggedIn: (state: AuthState, { payload }: PayloadAction<boolean>) => {
            state.loggedIn = payload;
        },
        signIn: (state: AuthState, { payload }: PayloadAction<{ token: string; user: any }>) => {
...
export const { setToken, setUser, resetUser, resetToken, setLoggedIn, authorizeWs, reset } =
    slice.actions;
